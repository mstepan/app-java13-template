...
public final class LongestBitonicSubSequence {
     ...
     */
    public static Collection<Integer> find(int[] arr) {
     ...
     * space: O(N)
     */
    public static Collection<Integer> findBruteforce(int[] arr) {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("backtracking: %s%n", find(arr));
        System.out.printf("bruteforce:   %s%n", findBruteforce(arr));
    }
}
